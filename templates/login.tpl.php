...
?>
	...
	<div class="row">
		<div class="span8">
			...
			<p>However, giving it to us is safe, and we believe we can earn your trust. We won't store your password in any form, so even in case of a full database breach, your account will not be compromised.</p>
